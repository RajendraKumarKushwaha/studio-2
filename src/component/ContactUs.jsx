        ...
        <div className="bg-white py-20">
            <div className="container mx-auto px-4">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600 mt-2">We are here to help you. Reach out to us anytime!</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
                    ...
                    <div className="bg-white p-8 shadow ">
                        ...
                        <form className="max-w-md mx-auto">
                            ...
                            <button type="submit" className="text-white bg-gray-900 hover:bg-gray-950 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium  text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                        </form>

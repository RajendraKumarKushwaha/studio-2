        ...
        <div className="container mx-auto px-4 py-24">
            ...
            <div className="flex gap-4 justify-center mb-6 flex-wrap">
                {galleryData.map((category) => (
                    <button
                        key={category.title}
                        className={`px-4 py-2 text-white cursor-pointer transition-all ${activeCategory === category.title ? "bg-[#f28b00]" : "bg-gray-800 hover:bg-gray-500"
                            }`}
            ...
            >
                {selectedGallery.images.map((src, idx) => (
                    <div key={idx} className="mb-4 overflow-hidden border-2 cursor-pointer" onClick={() => setLightbox({ isOpen: true, index: idx })}>

...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        " flex flex-col items-center justify-center overflow-hidden bg-slate-950 w-full  z-0",
        className
      )}>
      <div
        ...
        <motion.div
          ...
          className=" inset-auto right-1/2 h-100 overflow-visible w-[30rem] bg-gradient-conic from-cyan-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]">
          <div
            className="  w-[100%] left-0 bg-slate-950  bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
          <div
            className="  w-40 h-[100%] left-0 bg-slate-950  bottom-0 z-20 [mask-image:linear-gradient(to_right,white,transparent)]" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0.5, width: "15rem" }}
          whileInView={{ opacity: 1, width: "30rem" }}
      ...
      <div className="relative z-50 flex flex-col items-center px-5 mt-[-300px]">
